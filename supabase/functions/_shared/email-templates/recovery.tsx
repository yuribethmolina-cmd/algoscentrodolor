...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Restablece tu contraseña del panel ALGOS</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Recibimos una solicitud para restablecer la contraseña de tu cuenta en el panel interno de ALGOS.
