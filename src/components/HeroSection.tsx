...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 pointer-events-none bg-gradient-to-r from-[#f5f0e8]/[0.98] via-[#f5f0e8]/80 to-[#f5f0e8]/20 md:from-[#f5f0e8]/95 md:via-[#f5f0e8]/70 md:to-[#f5f0e8]/20"
      />
      {/* Bottom fade */}
      <div
        aria-hidden="true"
