...
ALGOS promociona servicios diagnósticos de UDUZ en su web e Instagram
Flujo: paciente entra por ALGOS → diagnóstico en UDUZ → procedimiento en ALGOS
...
- Pendiente: Google Analytics ID real · aprobación visual (Atilio + esposo)

## Preferencias de trabajo
- Español neutro latinoamericano, tuteo
- Cambios quirúrgicos — no tocar código que funciona
- No agregar comentarios innecesarios
- Commits atómicos en inglés
